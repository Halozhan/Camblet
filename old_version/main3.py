...
if __name__ == "__main__":
    ...
    while True:
        ...
        frame = frame[cutY:-400, cutX:-300] # cutting the not used section
        
        hsv = cv2.cvtColor(frame, cv2.COLOR_BGR2HSV) # convert bgr to hsv
        # masked_image = cv2.inRange(hsv, (100, 0, 0), (130, sv, sv)) tablet
        masked_image = cv2.inRange(hsv, (0, 0, 0), (255, saturation, value))
        ...
        for idx, centroid in enumerate(centroids):
            ...
            if area > 1500:
                ...
                # print("\n", nowX, centerX, "\n", nowY, centerY)
                """ cursor smoothing
                draw_steps = 2  # total times to update cursor
